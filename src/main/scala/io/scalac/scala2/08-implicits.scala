...
package implicits {
  ...
  package extensionMethods {
    ...
    object ImplicitConversions {
       ...
       * By convention these classes are named after the underlaying type suffied with `Ops`.
       */
       ...
       * to extend (most likeky from 3rd party library) to our wrapper object.
       */
    ...
    /**
     * The "Pimg my library" pattern was so popular that later it received special syntax called
  ...
  /**
   * Scalas strong type system and powerful features like implicit conversions enable programmers
   * to construct their own mini-languages embbeded in Scala to acurately describe specific
